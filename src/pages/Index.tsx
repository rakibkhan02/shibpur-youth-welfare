      ...
      <section id="home" className="relative min-h-[92vh] pt-24">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 md:px-8 lg:grid-cols-[1fr_0.8fr] lg:py-24">
          <div className="animate-reveal">
            <p className="mb-5 inline-flex rounded-full border border-primary/20 bg-card/80 px-4 py-2 text-sm font-bold text-primary shadow-sm backdrop-blur">অরাজনৈতিক • অলাভজনক • সেবামূলক</p>
