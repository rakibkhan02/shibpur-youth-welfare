        ...
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 text-lg leading-9 text-muted-foreground">
              মানবসেবা, সমাজকল্যাণ, শিক্ষার প্রসার, পরিবেশ সংরক্ষণ ও নৈতিক মূল্যবোধের বিকাশের মাধ্যমে একটি আদর্শ সমাজ গঠনের লক্ষ্যে আমরা, এলাকার সমাজ সচেতন যুবসমাজ ঐক্যবদ্ধভাবে ২০২৫ সালে “শিবপুর যুব কল্যাণ ফাউন্ডেশন নাইন্টিন” প্রতিষ্ঠা করেছি। আমরা বিশ্বাস করি— ঐক্য, সহমর্মিতা ও মানবতার চেতনায় উদ্বুদ্ধ হয়ে সমাজের অসহায়, দরিদ্র ও বঞ্চিত জনগোষ্ঠীর পাশে দাঁড়ানো আমাদের নৈতিক দায়িত্ব ও কর্তব্য।
            </p>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 md:px-8 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 space-y-4 text-lg font-semibold text-muted-foreground">
              ...
              <p className="flex gap-3"><Facebook className="mt-1 text-primary" /> <a href="https://www.facebook.com/share/1AuY5f7GGL/" target="_blank" rel="noreferrer" className="transition hover:text-primary">Shibpur Jubo Kollan Foundation 19</a></p>
            </div>
          </div>
